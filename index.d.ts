...
export declare const buildCheckoutLink: ({ addressSearch, specialInstructions, poNumber, contactInfo, canEdit, returnTo, source, products, propertyId }?: Props) => string;
export declare class ReceivedBothFulfillmentMethodAndFulfillmentMethodId extends Error {
    constructor();
}
export {};
